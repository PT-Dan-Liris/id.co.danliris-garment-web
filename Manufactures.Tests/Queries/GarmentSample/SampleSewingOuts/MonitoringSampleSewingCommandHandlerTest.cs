...
{
    public class MonitoringSampleSewingCommandHandlerTest : BaseCommandUnitTest
    {
        ...
        public MonitoringSampleSewingCommandHandlerTest()
        {
        ...
        private GetMonitoringSampleSewingQueryHandler CreateGetMonitoringSewingQueryHandler()
        {
            return new GetMonitoringSampleSewingQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
        }
		...
		{
			// Arrange
			GetMonitoringSampleSewingQueryHandler unitUnderTest = CreateGetMonitoringSewingQueryHandler();
            ...
            GetMonitoringSampleSewingQuery getMonitoring = new GetMonitoringSampleSewingQuery(1, 25, "{}", 1, DateTime.Now, DateTime.Now.AddDays(2), "token");

...
namespace Manufactures.Tests.Queries.GarmentSample.SampleFinishingOuts
{
    public class GetMonitoringSampleFinishingQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        //private readonly Mock<IGarmentSampleFinishingMonitoringReportRepository> garmentMonitoringFinishingReportRepository;

        //public GetMonitoringSampleFinishingQueryHandlerTest()
        //{
        //    _mockGarmentSampleSewingOutRepository = CreateMock<IGarmentSampleCuttingOutRepository>();
        //    _mockGarmentSampleSewingOutItemRepository = CreateMock<IGarmentSampleCuttingOutItemRepository>();

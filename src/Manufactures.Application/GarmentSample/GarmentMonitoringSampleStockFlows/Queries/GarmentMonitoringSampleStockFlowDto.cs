...
{
    public class GarmentMonitoringSampleStockFlowDto
    {
        public GarmentMonitoringSampleStockFlowDto()
        {
        }
        ...
        public GarmentMonitoringSampleStockFlowDto(GarmentMonitoringSampleStockFlowDto flowDto)
        {

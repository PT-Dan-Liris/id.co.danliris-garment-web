		...
		public async Task<MemoryStream> Handle(GetXlsMonitoringProductionStockFlowQuery request, CancellationToken cancellationToken)
		{
            ...
            var BasicPrices = (from a in sumbasicPrice
                               ...
                               select new
                               {
                                   ...
                                   //* 
                                   Math.Round(Convert.ToDouble((bb != null ? (bb.FC / bb.Count) : 0) == 0 ? cc == null ? 0 : cc.BasicPrice : Math.Round(Convert.ToDouble(a.BasicPrice / a.Count), 2)) * Convert.ToDouble(bb != null ? bb.FC / bb.Count : 0),2),
                                   realization = a.RO
                               }).ToList();
